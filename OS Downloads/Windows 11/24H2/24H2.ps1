...
$Windows1124H2URL = "https://github.com/osdcloudcline/Scripts/raw/main/OS%20Downloads/Windows%2011/24H2/26100.1742_amd64_en-us_multi_e1d5e11a_convert_virtual.zip"
...
Expand-Archive -Path "$ZIPDestination\26100.1742_amd64_en-us_multi_e1d5e11a_convert_virtual.zip" -DestinationPath $ZIPDestination

pause

Write-Host
Write-Host "Downloading Windows 11 24H2 Build: 26100.1742..." -ForegroundColor Cyan 
