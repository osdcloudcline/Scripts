...
Write-Host "ATTN: $env:username - 21 pieces of software will be installed. Please be patient" -ForegroundColor Red
...
$Utilitiesapp1 = "7-Zip"
$Utilitiesapp2 = "Wise Registry Cleaner"
$Utilitiesapp3 = "Windows Admin Center"
$Utilitiesapp4 = "Windows 11 22H2 SDK"
$Utilitiesapp5 = "Windows 11 22H2 ADK"
$Utilitiesapp6 = "Windows 11 22H2 ADK PE Add-On"
$Utilitiesapp7 = "Display Driver Uninstaller"
$Utilitiesapp8 = "Rufus"
$Utilitiesapp9 = "Logitech Unifying Software"
$Utilitiesapp10 = "Logitech Options"
...
Write-Host
Write-Host
Write-Verbose "Acquiring $Utilitiesapp4 setup file from OSDCloudCline GitHub OSDCloud\OS Kits repository...." -Verbose 
...
Write-Host
Write-Host
Write-Verbose "Acquiring $Utilitiesapp5 setup file from OSDCloudCline GitHub OSDCloud\OS Kits repository...." -Verbose 
$OSDCloudGHdownloads = "C:\OSDCloud\GitHub\downloads"
...
Write-Host
Write-Host
Write-Host "Step 5: Security Software" -ForegroundColor Cyan
Write-Host
Write-Host
...
Write-Host
Write-Host
Write-Host "Step 6: Messaging Software" -ForegroundColor Cyan
Write-Host
Write-Host
...
Write-Host
Write-Host
Write-Host "Step 7: OS Features" -ForegroundColor Cyan
Write-Host
Write-Host
