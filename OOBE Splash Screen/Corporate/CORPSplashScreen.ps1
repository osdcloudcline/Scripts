$CORPprocesses = @(
  ...
  @{
  Name = "Corporate  Client Software Installation Package"
  Script = "https://github.com/osdcloudcline/Scripts/raw/main/WinGet%20/Install%20/Custom%20Configurations/Corporate/Corporate.ps1"
  },
  @{
