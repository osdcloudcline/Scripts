$ITprocesses = @(
  ...
  @{
  Name = "IT Help Desk Technician Client Software Installation Package"
  Script = "https://github.com/osdcloudcline/Scripts/raw/main/WinGet%20/Install%20/Custom%20Configurations/IT%20Tech/ITTech.ps1"
  },
  @{
