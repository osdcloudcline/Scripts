...
$selection = Read-Host 'Please choose an option'
 ...
 '5'{cls
       ...
       Start-Sleep -Seconds 5
       Import-Module -Name OSD -Force
       $W1125H1 = Invoke-WEbRequest("https://github.com/osdcloudcline/Scripts/raw/main/PostInstall/OSDebloat/Windows%2011%20/25H1/Debloat25H1.ps1")
 ...
 '6' {cls
       ...
       Start-Sleep -Seconds 5
       Import-Module -Name OSD -Force
       $W1125H2 = Invoke-WebRequest("https://github.com/osdcloudcline/Scripts/raw/main/PostInstall/OSDebloat/Windows%2011%20/25H2/Debloat25H2.ps1")
