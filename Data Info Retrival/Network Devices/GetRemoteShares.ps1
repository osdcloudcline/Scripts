...
Write-Host '       the username and password to connect                                     ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host ' This script maps the remote share to drive letter Z:                           ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                                ' -BackgroundColor White 
